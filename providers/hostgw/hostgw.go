...
func NewInst(metadataAddress string) (*HostGw, error) {
	m, err := metadata.NewClientAndWait(fmt.Sprintf(providers.MetadataURL, metadataAddress))
	if err != nil {
